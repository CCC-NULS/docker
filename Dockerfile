...
ENV PACKAGE "NULS_Wallet_linux64_2.5.0.tar.gz"
ENV URL="http://nuls-usa-west.oss-us-west-1.aliyuncs.com/linux/${PACKAGE}"
ENV PACKAGE_FOLDER "NULS_Wallet_linux64_2.5.0"
